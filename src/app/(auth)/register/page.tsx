...
const RegisterPage = () => {
  return (
    <Container component="main" maxWidth="xl" sx={{ display: 'flex', justifyContent: 'space-between'}}>
      <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', paddingLeft: 15 }}>
        ...
        <Typography variant="h2" gutterBottom sx={{ marginTop: 2, marginBottom: 2 }}>
          your journey of
        </Typography>
      ...
      <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center', paddingRight: 15 }}>
        <Paper elevation={3} sx={{ p: 4, maxWidth: 400, margin: '0 auto', backgroundColor: '#f1efea'}}>
          ...
          <Typography variant="body2" sx={{ mt: 5 }}>
            ...
            <Link style={{color: 'blue'}} href="/login">Sign in</Link>
          </Typography>
        </Paper>
      </Box>
    </Container>
